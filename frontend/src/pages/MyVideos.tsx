...
const MyVideos: React.FC = () => {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      {!userId && (
        <div
          style={{ padding: 24, border: '1px solid #eef2f7', borderRadius: 12, background: '#fff', marginBottom: 16 }}
        >
      ...
      {userId && videos.length === 0 && !loading && !error ? (
        <div style={{ padding: 24, border: '1px solid #eef2f7', borderRadius: 12 }}>
          <p style={{ margin: 0, color: '#6b7280' }}>
            Encara no tens vídeos. Penja el primer vídeo des del botó "Crea".
          </p>
        </div>
      ) : userId ? (
          ...
          {videos.map((v) => {
            ...
            return (
              <div key={v.fileName} style={{ padding: 12, borderRadius: 8, background: '#fff', position: 'relative' }}>
                <Link
                  to={`/video/${encodeURIComponent(v.fileName)}`}
                ...
                >
                  <div
                    style={{
                      width: '100%',
                      height: 160,
                      background: `url(${posterUrl}) center/cover, #000`,
                      borderRadius: 8,
                      marginBottom: 8,
                    }}
                  />
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              ...
              <button className="ghost" onClick={() => setCommentsOpen(false)}>
                ✕
              </button>
            </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto' }}>
              {commentsLoading ? (
                ...
                <div style={{ padding: 20, textAlign: 'center', color: '#6b7280' }}>
                  No hi ha comentaris en aquest vídeo.
                </div>
              ) : (
            ...
            <div style={{ marginTop: 12, textAlign: 'right' }}>
              <button className="action-btn" onClick={() => setCommentsOpen(false)}>
                Tancar
              </button>
            </div>
          </div>
